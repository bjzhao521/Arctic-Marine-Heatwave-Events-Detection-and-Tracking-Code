...
Code for the manuscript *"Anomalous Sea-Ice Loss Precedes Intense Arctic Marine
Heatwaves"* (Zhao, Sun & Horvat). Detects marine heatwaves (MHWs) north of 60N
over 1982-2025 and aggregates them into spatiotemporally connected events.

The event catalog and daily animations produced by this code are archived on
Zenodo: https://doi.org/10.5281/zenodo.22801471
...
Please cite the paper and the Zenodo dataset (DOI above). Code license: MIT.
